...
export default function SignForm() {
  ...
  return (
    <section className="w-full h-screen flex justify-center items-center bg-black px-[10px]">
      <main className="w-full max-w-[500px] border border-[#3D3D3D] sm:px-6 md:px-10 py-[40px] bg-[#2C2C2C] rounded-[12px] flex flex-col items-center justify-center space-y-[20px]">
        ...
        <form className="flex flex-col gap-4 w-full items-center space-y-[20px]">
          ...
          <div className="w-full max-w-[350px]">
            ...
            <div className="relative mt-2">
              ...
              <input
                ...
                className="w-full h-[44px] pl-[41px] pr-3 bg-transparent text-white border border-gray-600 rounded-[8px] text-[14px] focus:border-[#1D61E7] outline-none"
          ...
          <div className="w-full max-w-[350px]">
            ...
            <div className="relative mt-2">
              ...
              <input
                ...
                className="w-full h-[44px] pl-[41px] pr-12 bg-[#3D3D3D] text-white border border-gray-600 rounded-[8px] text-[14px] focus:border-[#1D61E7] outline-none"
                aria-label="Password"
              />
          ...
          <button
            ...
            className="w-[450px] max-w-[350px] h-[46px] bg-[#1D61E7] text-[#FFFFFF] text-[15px] rounded-[10px] hover:bg-[#1548b5] transition-all"
          >
            Sign In
          </button>
